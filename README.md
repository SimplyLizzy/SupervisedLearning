...
Based on the results that were output when running the logistic regression tests, 

The original data on the logistic regression showed Training to have 64% accuracy, and Testing to have 52% accuracy.

The Random Forest Classifier model showed Training at 100% and Testing at 61%. Which was higher than the original data. The results were the same on the scaled model.

The final example, which also showed to be the mose accurate, was the Logistic Regression model on a scaled data. Where the Training was at 71% accuracy, and the Testing score was at 72%.
